...
{name: "Ameerat El Arab",
  notes: ["Rose", "Jasmin","Oud", "Ambre", "Musc"],
  familleOlf: "Florale",
  favoris: true,
  src: "assets/images/ameeratElArab.jpg",
  genre: "femme",
  description: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam odit sint beatae, blanditiis voluptatibus ratione quos maiores id consequatur iure nobis voluptatem exercitationem impedit cupiditate voluptatum amet quaerat ut qui?",
}, 
{name: "Dolce & Gabbana Light Blue",
  notes: ["Pomme", "Cèdre", "Citron", "Jasmin", "Musc"],
  familleOlf: "Fruitée",
  favoris: true,
  src: "assets/images/lightBlueDG.jpg",
  genre: "femme",
  description: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam odit sint beatae, blanditiis voluptatibus ratione quos maiores id consequatur iure nobis voluptatem exercitationem impedit cupiditate voluptatum amet quaerat ut qui?",
}, 
...
notes: ["Fruits exotiques", "Fleurs blanches", "Vanille", "Musc", "Bois de santal"],
familleOlf: "Fruitée",
favoris: false,
src: "assets/images/erbaPura.jpg",
genre: "unisex",
description: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam odit sint beatae, blanditiis voluptatibus ratione quos maiores id consequatur iure nobis voluptatem exercitationem impedit cupiditate voluptatum amet quaerat ut qui?",
},
]
...
// stocker les favoris 
// faire un map des elements preferés et la stocker
...
description.style.display = description.style.display === 'none' ? 'block' : 'none'; // description en toggle en clickant le button
}
...
heart.addEventListener('click', function (e) {
  const card = e.target.closest('.card');// la div card plus proche donc celle du parfum en question
  const name = card.querySelector(".card-name").innerText; // recuperer nom du parfum
  const selectedPerfume = perfumeList.find(perfume => perfume.name === name); // comparer le parfum avec la propriete. name

  if (selectedPerfume) {
    selectedPerfume.favoris = !selectedPerfume.favoris; //passe à la valeur opposée
    const heartIcon = heart.querySelector("i");
    heartIcon.className = selectedPerfume.favoris ? "fa-solid fa-heart" : "fa-regular fa-heart";// toggle entre coeur plein et vide
    // savePerfumeListToLocalStorage(); // enregistrer dans localstorage
  }
});
});
